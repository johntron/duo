...
/*
 * Get or set whether require() should be defined globally
 *
 * @param {Boolean} global_require
 * @return {Boolean|Duo}
 * @api public
 */

Duo.prototype.global_require = function(global_require){
  if (!arguments.length) return this._global_require;
  this._global_require = global_require;
  return this;
};
...
Duo.prototype.run = unyield(function *() {
  ...
  opts.global_require = this.global_require();
